...
<div id="qge">
    ...
    <img data-quest="open" src="<?php echo GP_LOCATE; ?>img/q/l<?php echo $session->userinfo['tribe'];?>g.jpg" title="To the task" style="height:174px" alt="To the task" />
    <?php }else{?>
    <img data-quest="open" src="<?php echo GP_LOCATE; ?>img/q/l<?php echo $session->userinfo['tribe'];?>.jpg" title="To the task" style="height:174px" alt="To the task" />
    <?php } ?>
</div>
